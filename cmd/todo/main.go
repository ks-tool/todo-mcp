...
func contractCommand() *cobra.Command {
	return &cobra.Command{
		...
		Short: "check an API contract (OpenAPI JSON/YAML, gRPC .proto, or GraphQL SDL)",
...
func emitSchema() {
	schema := map[string]any{
		...
		"commands": map[string]string{
			...
			"contract":     "<consumer-spec> <provider-spec> — check an API contract (OpenAPI JSON/YAML, gRPC .proto, GraphQL SDL)",
